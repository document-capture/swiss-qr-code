codeunit 61111 "PTE DC SwissQR Decode"
{
    ...
    begin
        ...
        exit(LogErrorAndExit(WrongCurrencyLbl, not SwissQRBillMgt_AllowedISOCurrency(CurrencyText), true));
    end;

    internal procedure SwissQRBillMgt_AllowedISOCurrency(CurrencyText: Text): Boolean
    begin
